...
pub enum ComparisonErrorCode {
    ...
    RegionOutOfBounds,
    RegionEmpty,
    SemanticMetadataTooLarge,
    SemanticFindingsLimitExceeded,
    SemanticOverlapCandidateLimitExceeded,
    SemanticMetadataInvalid,
    SemanticConfigInvalid,
    SemanticTargetRootMissing,
    SemanticIdentityInvalid,
    AiInputTooLarge,
    AiInputInvalid,
    AiImageTooLarge,
    AiConfigInvalid,
