...
- [x] 每个阶段完成后运行对应验证，并按阶段独立提交。（验证：阶段 1-7 均记录测试证据并产生独立业务提交，summary/checklist 未进入提交）
...
- [x] 更新 `docs/fangyuan/` 或 `docs/scene/` 中共享玩家渲染、尺寸和生命周期说明。（验证：`docs/scene/游戏层场景使用说明.md` 记录共享 runtime、尺寸/Y=0、character/session/generation、快照/recovery/teardown、fixture 和测量口径）
...
- 开始时间：2026-08-12 13:19:42 +08:00
- 结束时间：2026-08-12 16:46:19 +08:00
- 验收总结：共享 Fangyuan 玩家视觉、主世界权威多人实体、恢复/退出生命周期和固定视口离线视觉回归均完成；7 个阶段分别提交业务改动，checklist 与截图留在未提交的 summary 验收区。
