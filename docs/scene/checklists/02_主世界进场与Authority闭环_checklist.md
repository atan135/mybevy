...
- 主世界 HUD 和场景内按钮由 `03_主世界HUD与场景内面板_checklist.md` 负责。
...
- [x] 更新 `docs/scene/`、`docs/myserver/` 和必要的上手文档，说明固定公共房间进场链路。（验证：17c3d62 记录 StartRoom/late join/ready/家园语义及 Windows-only 网络验收边界。）
