...
- [x] 更新 `docs/场景/` 中受影响的主世界静态场景说明；如未影响上手流程，记录无需修改 `docs/引擎入门使用文档.md`。（验证：`docs/场景/游戏层场景使用说明.md` 已补 4000m、单 Mesh 预算、camera-scoped 渲染、资源清理和阴影策略；本阶段未改变上手流程，`docs/引擎入门使用文档.md` 无需修改）
