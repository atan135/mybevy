...
- [x] 每个阶段完成后运行对应验证，并按阶段独立提交。（验证：阶段 1-6 均记录测试证据；业务提交为 `40a2dda`、`2309de1`、`7778383`、`5653f81`、`7aef6e8`、`c694c34`、`fef69b2`，清单/summary 未进入提交）
...
- [x] 更新 `docs/场景/摄像机管理系统设计.md` 和受影响的摄像机功能说明。（审核：新增 world.main orbit/input/lifecycle/验收章节，并修正 ScenePlugin loading UI/camera 实际顺序）
